...
export interface PodiumProps {
    ...
    users?: ({ color: string; name: string })[]
}
    ...
    return (
        <div className="flex w-full h-full pt-2 justify-center items-end gap-[16px]">
            <div className="flex flex-col items-center w-[80px] h-[160px] bg-primary-300 rounded-t-full p-2">
                ...
                <span
                    className="text-center text-white font-inter text-[10px] truncate max-w-[60px] overflow-hidden whitespace-nowrap">
                    {second_username}
                </span>
            </div>
            ...
            <div className="flex flex-col items-center w-[100px] h-[180px] bg-primary-500 rounded-t-full p-2 relative">
                ...
                <span
                    className="text-center text-white font-inter text-[10px] truncate max-w-[80px] overflow-hidden whitespace-nowrap">
                    {first_username}
                </span>
            </div>
