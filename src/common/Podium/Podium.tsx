        ...
        <div className="flex justify-center items-end gap-[var(--Space-200,8px)] flex-1 self-stretch py-[var(--Space-200,8px)]">
            <div className="flex flex-col justify-center items-center gap-[var(--Space-200,8px)] w-16">
                ...
                <div className="flex h-18 flex-col justify-center items-center gap-[var(--Space-200, 8px)]">
                    <Avatar imageSrc={second} size={"xlarge"}/>
                    <span
                        className="text-text-black text-center font-inter text-xs leading-[120%] self-stretch">{second_username}</span>
            ...
            <div className="flex flex-col justify-center items-center gap-[var(--Space-200,8px)] w-16">
                ...
                <div className="flex h-18 flex-col justify-center items-center gap-[var(--Space-200, 8px)]">
                    ...
                    <span
                        className="text-text-black text-center font-inter text-xs leading-[120%] self-stretch">{first_username}</span>
                </div>

            </div>
            <div className="flex flex-col justify-center items-center gap-[var(--Space-200,8px)] w-16">
                <div
                    className="flex justify-center items-start gap-[var(--Space-200,8px)] h-16 py-[var(--Space-200,8px)] self-stretch rounded-[var(--Icon-Small,24px)] bg-[var(--Primary-ui-primary-100,#A9E0E1)] shadow-[0px_2px_4px_1px_rgba(0,0,0,0.25)]">
                    <NumberIcon number={3} size={"large"} colorClass={"white"}/>
                </div>
                <div className="flex h-18 flex-col justify-center items-center gap-[var(--Space-200, 8px)]">
                    <Avatar imageSrc={third} size={"xlarge"}/>
                    <span
                        className="text-text-black text-center font-inter text-xs leading-[120%] self-stretch">{third_username}</span>
                </div>
