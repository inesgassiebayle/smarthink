...
const ModuleDetailsPopUp: FunctionComponent<ModuleDetailsPopUpProps> = ({ modules, teacherImg, teacher, title, rating, subject, information }) => {
    ...
    return (
        <div className="w-full max-w-[336px] h-full max-h-[90vh] sm:max-h-[80vh] md:max-h-[672px] relative rounded-2xl bg-grayscale-white border-grayscale-gray-300 border-[0.5px] border-solid flex flex-col items-center p-4 sm:p-6">
