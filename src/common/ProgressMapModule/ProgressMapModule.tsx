...
const ProgressMapModule: FunctionComponent<ProgressMapModuleProps> = ({
    ...
    return (
        <div className="flex items-start gap-[var(--Space-200,8px)] w-[90%] px-[var(--Space-200,8px)]">
            <ProgressMapIcon variant={variant} state={state} />

            {variant === "completed" ? (
                <div className="flex items-center gap-[var(--Space-200,8px)] w-[90%] h-[51px] px-[var(--Space-200,8px)] flex-shrink-0 rounded-[var(--Radius-200,8px)] bg-[var(--Answers-ui-success,#58C25C)] shadow-[0px_2px_4px_0px_#DDE4E4]" >
                ...
                <div className="flex items-center gap-[var(--Space-200,8px)] w-[90%] h-[51px] px-[var(--Space-200,8px)] flex-shrink-0 rounded-[var(--Radius-200,8px)] border border-[0.25px] border-[var(--Grayscale-gray-100,#DDE4E4)] bg-white shadow-[0px_2px_4px_0px_#DDE4E4]" onClick={onClick}>
